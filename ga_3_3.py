...
# O GA3.3 Interpolação de peso de Operador:
# -> Os pesos iniciais do crossover e mutação são 0,7 e 0,3 respectivamente 
# E esses valores são alterados a cada geração
# No fim os pesos devem ser 0,5 e 0,5 para cada operador
...
### def main(args): ###
print("Algoritmo genético 3-3")
arquivoTxt = open('resposta.txt', 'w', encoding='utf-8')
arquivoTxt.write('Algoritmo genético 3-3 \n')
...
for i1 in range(geracoes):
  ...
  # Interpolação dos pesos dos operadores
  seleciona_cro -= interpolacao_peso
  seleciona_mut += interpolacao_peso
