...
# O GA3.1 evita que o crossover e a mutação aconteça no mesmo momento:
# -> Pode acontecer apenas o crossover ou a mutação na reprodução
# -> O crossver continua normal
# -> A mutação seleciona apenas um pai
